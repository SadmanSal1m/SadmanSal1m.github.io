 ...
 * License: MIT + Commons Clause. Adapted: TypeScript nocheck, CSS moved to
 * globals.css with the container centered inside its parent instead of pinned
 * to the page corner, and card chrome removed so device frames supply it. */
...
const CardSwap = ({
  ...
  return (
    <div ref={container} className="card-swap-container" style={{ width: '100%', height: '100%' }}>
      {rendered}
    </div>
  );
};
