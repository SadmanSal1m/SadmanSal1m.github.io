 ...
 * License: MIT + Commons Clause. Adapted: TypeScript nocheck, CSS in globals,
 * pointer listener moved from the container to the window so the effect still
 * reacts to the mouse when mounted behind a pointer-events-none overlay. */
